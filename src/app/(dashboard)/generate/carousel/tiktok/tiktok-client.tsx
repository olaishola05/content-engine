...
import TikTokPreview from '@/components/carousel/tiktok-preview';
    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 max-w-[1200px] w-full mx-auto px-6 py-8 space-y-8">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-[#171717]">Generate TikTok Carousel</h1>
          <p className="text-sm text-[#4d4d4d]">Enter content to generate a 3-5 slide carousel preview and export.</p>
        </div>
